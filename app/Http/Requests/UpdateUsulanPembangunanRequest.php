...
class UpdateUsulanPembangunanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status_usulan' => ['nullable', Rule::in(UsulanPembangunan::STATUSES)],
            'status_pelaksanaan' => ['nullable', Rule::in(['belum_dilaksanakan', 'sedang_dilaksanakan', 'sudah_dilaksanakan'])],
            'tahun_realisasi' => ['nullable', 'integer', 'min:2020', 'max:2100'],
