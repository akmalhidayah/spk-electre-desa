                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-group icon-actions">
                                            ...
                                            @if ($keputusan)
                                                <a href="{{ route('kepala-desa.keputusan-akhir.pdf', $keputusan) }}" class="btn btn-sm btn-secondary action-icon-btn" target="_blank" title="Cetak PDF keputusan akhir" aria-label="Cetak PDF keputusan akhir">
                    ...
                    @foreach ($calculations as $calculation)
                        ...
                        <article class="mobile-card">
                            ...
                            <div class="mobile-actions">
                                ...
                                @if ($keputusan)
                                    <a href="{{ route('kepala-desa.keputusan-akhir.pdf', $keputusan) }}" class="btn btn-sm btn-secondary" target="_blank">PDF Keputusan</a>
                                @endif
                            </div>
                        </article>
                    @endforeach
